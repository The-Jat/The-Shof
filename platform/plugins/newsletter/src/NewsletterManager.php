...
class NewsletterManager extends Manager implements Factory
{
    ...
    public function registerNewsletterPopup(bool $force = false): void
    {
        ...
        if (
            ...
            && ($force || ! isset($_COOKIE['newsletter_popup']))
            ...
            add_filter(THEME_FRONT_BODY, function (string|null $html) use ($force): string|null {
